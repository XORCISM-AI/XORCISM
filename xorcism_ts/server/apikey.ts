...
export const API_SCOPES = ["assets:read", "assets:write", "incidents:read", "incidents:write", "exposure:read", "risk:read", "identities:read", "compliance:read", "policies:read", "configuration:read", "crisis:read", "fairmam:read", "tid:read"] as const;
