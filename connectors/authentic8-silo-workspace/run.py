"""run.py — XORCISM OSINT pivot connector: Authentic8 Silo Workspace.

Foundational OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/authentic8-silo-workspace

Turns a `target` observable into a pivot — a deep-link into Authentic8 Silo Workspace when it exposes
...
SLUG = 'authentic8-silo-workspace'
TOOL_NAME = 'Authentic8 Silo Workspace'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/authentic8-silo-workspace'
