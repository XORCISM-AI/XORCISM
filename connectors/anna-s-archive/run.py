"""run.py — XORCISM OSINT pivot connector: Anna's Archive.

Archiving OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/annas-archive

Turns a `target` observable into a pivot — a deep-link into Anna's Archive when it exposes
...
SLUG = 'annas-archive'
TOOL_NAME = "Anna's Archive"
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/annas-archive'
CATEGORY = 'Archiving OSINT'
