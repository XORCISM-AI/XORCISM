"""run.py — XORCISM OSINT pivot connector: Deaddrop.

Social Media OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/deaddrop

Turns a `target` observable into a pivot — a deep-link into Deaddrop when it exposes
...
SLUG = 'deaddrop'
TOOL_NAME = 'Deaddrop'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/deaddrop'
