"""run.py — XORCISM OSINT pivot connector: Baidu Maps.

Geolocation & Maps OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/baidu-maps

Turns a `target` observable into a pivot — a deep-link into Baidu Maps when it exposes
...
SLUG = 'baidu-maps'
TOOL_NAME = 'Baidu Maps'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/baidu-maps'
