"""run.py — XORCISM OSINT pivot connector: Filmot.

Image & Video Analysis OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/filmot

Turns a `target` observable into a pivot — a deep-link into Filmot when it exposes
...
SLUG = 'filmot'
TOOL_NAME = 'Filmot'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/filmot'
