"""run.py — XORCISM OSINT pivot connector: Analyst Research Tools.

Email Address OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/analyst-research-tools

Turns a `target` observable into a pivot — a deep-link into Analyst Research Tools when it exposes
...
SLUG = 'analyst-research-tools'
TOOL_NAME = 'Analyst Research Tools'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/analyst-research-tools'
CATEGORY = 'Email Address OSINT'
