"""run.py — XORCISM OSINT pivot connector: USPTO.

Public Records OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/uspto

Turns a `target` observable into a pivot — a deep-link into USPTO when it exposes
...
SLUG = 'uspto'
TOOL_NAME = 'USPTO'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/uspto'
