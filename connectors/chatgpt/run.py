"""run.py — XORCISM connector SCAFFOLD for ChatGPT.

OpenAI's AI assistant
Tool: https://chat.openai.com/
Category: OSINT   (XORCISM.TOOL #837)

Generated by connectors/tool_to_connector.py. Implement run() to map ChatGPT output to
...
def run(params: Dict[str, Any], workdir: str) -> Dict[str, Any]:  # noqa: ARG001
    ...
    # TODO: implement the ChatGPT integration:
    #   • live mode  -> invoke ChatGPT against `target` (respect the engagement scope), or
    #   • offline    -> parse the saved output at `path`,
    # then return the normalized result (example shape below).
    raise NotImplementedError(
        f"Connector 'chatgpt' ({TOOL_NAME}) is a scaffold - implement run() in "
        f"connectors/chatgpt/run.py (tool: {TOOL_URL})."
    )
