"""run.py — XORCISM OSINT pivot connector: Wayback Machine.

Archiving OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/wayback-machine

Turns a `target` observable into a pivot — a deep-link into Wayback Machine when it exposes
...
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/wayback-machine'
