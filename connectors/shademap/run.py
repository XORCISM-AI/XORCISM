"""run.py — XORCISM OSINT pivot connector: ShadeMap.

Geolocation & Maps OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/shademap

Turns a `target` observable into a pivot — a deep-link into ShadeMap when it exposes
...
SLUG = 'shademap'
TOOL_NAME = 'ShadeMap'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/shademap'
