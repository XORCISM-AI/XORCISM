"""run.py — XORCISM OSINT pivot connector: Tiny Scan.

Network Infrastructure OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/tiny-scan

Turns a `target` observable into a pivot — a deep-link into Tiny Scan when it exposes
...
SLUG = 'tiny-scan'
TOOL_NAME = 'Tiny Scan'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/tiny-scan'
