"""run.py — XORCISM OSINT pivot connector: Apple Maps.

Geolocation & Maps OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/apple-maps

Turns a `target` observable into a pivot — a deep-link into Apple Maps when it exposes
...
SLUG = 'apple-maps'
TOOL_NAME = 'Apple Maps'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/apple-maps'
