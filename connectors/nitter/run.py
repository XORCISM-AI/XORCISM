"""run.py — XORCISM OSINT pivot connector: Nitter.

Social Media OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/nitter

Turns a `target` observable into a pivot — a deep-link into Nitter when it exposes
...
SLUG = 'nitter'
TOOL_NAME = 'Nitter'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/nitter'
