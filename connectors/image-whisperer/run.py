"""run.py — XORCISM OSINT pivot connector: Image Whisperer.

Image & Video Analysis OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/image-whisperer

Turns a `target` observable into a pivot — a deep-link into Image Whisperer when it exposes
...
SLUG = 'image-whisperer'
TOOL_NAME = 'Image Whisperer'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/image-whisperer'
