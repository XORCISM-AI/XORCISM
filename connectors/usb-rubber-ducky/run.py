"""run.py — XORCISM connector SCAFFOLD for USB Rubber Ducky.

USB keystroke injection device
Tool: n/a
Category: OSINT   (XORCISM.TOOL #897)

Generated by connectors/tool_to_connector.py. Implement run() to map USB Rubber Ducky output to
...
def run(params: Dict[str, Any], workdir: str) -> Dict[str, Any]:  # noqa: ARG001
    ...
    # TODO: implement the USB Rubber Ducky integration:
    #   • live mode  -> invoke USB Rubber Ducky against `target` (respect the engagement scope), or
    #   • offline    -> parse the saved output at `path`,
    # then return the normalized result (example shape below).
    raise NotImplementedError(
        f"Connector 'usb-rubber-ducky' ({TOOL_NAME}) is a scaffold - implement run() in "
        f"connectors/usb-rubber-ducky/run.py (tool: {TOOL_URL})."
    )
