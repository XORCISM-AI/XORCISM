"""run.py — XORCISM OSINT pivot connector: Your social media fingerprint.

Foundational OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/your-social-media-fingerprint

Turns a `target` observable into a pivot — a deep-link into Your social media fingerprint when it exposes
...
SLUG = 'your-social-media-fingerprint'
TOOL_NAME = 'Your social media fingerprint'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/your-social-media-fingerprint'
