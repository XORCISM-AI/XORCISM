"""run.py — XORCISM OSINT pivot connector: Telegago.

Social Media OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/telegago-telegram

Turns a `target` observable into a pivot — a deep-link into Telegago when it exposes
...
SLUG = 'telegago-telegram'
TOOL_NAME = 'Telegago'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/telegago-telegram'
