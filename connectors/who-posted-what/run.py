"""run.py — XORCISM OSINT pivot connector: Who posted what?.

Social Media OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/who-posted-what-facebook-tool

Turns a `target` observable into a pivot — a deep-link into Who posted what? when it exposes
...
SLUG = 'who-posted-what-facebook-tool'
TOOL_NAME = 'Who posted what?'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/who-posted-what-facebook-tool'
