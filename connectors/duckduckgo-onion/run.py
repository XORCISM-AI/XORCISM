"""run.py — XORCISM connector SCAFFOLD for DuckDuckGo Onion.

Private search on Tor
Tool: n/a
Category: OSINT   (XORCISM.TOOL #789)

Generated by connectors/tool_to_connector.py. Implement run() to map DuckDuckGo Onion output to
...
def run(params: Dict[str, Any], workdir: str) -> Dict[str, Any]:  # noqa: ARG001
    ...
    # TODO: implement the DuckDuckGo Onion integration:
    #   • live mode  -> invoke DuckDuckGo Onion against `target` (respect the engagement scope), or
    #   • offline    -> parse the saved output at `path`,
    # then return the normalized result (example shape below).
    raise NotImplementedError(
        f"Connector 'duckduckgo-onion' ({TOOL_NAME}) is a scaffold - implement run() in "
        f"connectors/duckduckgo-onion/run.py (tool: {TOOL_URL})."
    )
