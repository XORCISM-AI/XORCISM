"""run.py — XORCISM OSINT pivot connector: TinEye.

Image & Video Analysis OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/tineye

Turns a `target` observable into a pivot — a deep-link into TinEye when it exposes
...
SLUG = 'tineye'
TOOL_NAME = 'TinEye'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/tineye'
