"""run.py — XORCISM OSINT pivot connector: District 4 Labs Darkside.

People OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/district-4-labs-darkside

Turns a `target` observable into a pivot — a deep-link into District 4 Labs Darkside when it exposes
...
SLUG = 'district-4-labs-darkside'
TOOL_NAME = 'District 4 Labs Darkside'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/district-4-labs-darkside'
