"""run.py — XORCISM OSINT pivot connector: YouTube Video Finder.

Social Media OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/youtube-video-finder

Turns a `target` observable into a pivot — a deep-link into YouTube Video Finder when it exposes
...
TOOL_NAME = 'YouTube Video Finder'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/youtube-video-finder'
