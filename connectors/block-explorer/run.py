"""run.py — XORCISM OSINT pivot connector: Block Explorer.

Blockchain/Cryptocurrency OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/block-explorer

Turns a `target` observable into a pivot — a deep-link into Block Explorer when it exposes
...
SLUG = 'block-explorer'
TOOL_NAME = 'Block Explorer'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/block-explorer'
CATEGORY = 'Blockchain/Cryptocurrency OSINT'
