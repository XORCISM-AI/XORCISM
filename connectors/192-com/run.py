"""run.py — XORCISM OSINT pivot connector: 192.com.

People OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/192.com

Turns a `target` observable into a pivot — a deep-link into 192.com when it exposes
...
SLUG = '192.com'
TOOL_NAME = '192.com'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/192.com'
