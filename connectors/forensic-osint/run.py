"""run.py — XORCISM OSINT pivot connector: Forensic OSINT.

Foundational OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/forensic-osint

Turns a `target` observable into a pivot — a deep-link into Forensic OSINT when it exposes
...
SLUG = 'forensic-osint'
TOOL_NAME = 'Forensic OSINT'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/forensic-osint'
