"""run.py — XORCISM OSINT pivot connector: Forebears.

People OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/forebears

Turns a `target` observable into a pivot — a deep-link into Forebears when it exposes
...
SLUG = 'forebears'
TOOL_NAME = 'Forebears'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/forebears'
