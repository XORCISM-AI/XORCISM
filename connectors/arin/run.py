"""run.py — XORCISM OSINT pivot connector: ARIN.

Domain Name OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/arin

Turns a `target` observable into a pivot — a deep-link into ARIN when it exposes
...
SLUG = 'arin'
TOOL_NAME = 'ARIN'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/arin'
