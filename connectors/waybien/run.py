"""run.py — XORCISM OSINT pivot connector: Waybien.

Social Media OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/waybien

Turns a `target` observable into a pivot — a deep-link into Waybien when it exposes
...
SLUG = 'waybien'
TOOL_NAME = 'Waybien'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/waybien'
