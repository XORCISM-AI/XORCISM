"""run.py — XORCISM OSINT pivot connector: That's Them.

People OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/thats-them

Turns a `target` observable into a pivot — a deep-link into That's Them when it exposes
...
SLUG = 'thats-them'
TOOL_NAME = "That's Them"
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/thats-them'
