"""run.py — XORCISM OSINT pivot connector: Zehef.

Email Address OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/zehef

Turns a `target` observable into a pivot — a deep-link into Zehef when it exposes
...
SLUG = 'zehef'
TOOL_NAME = 'Zehef'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/zehef'
