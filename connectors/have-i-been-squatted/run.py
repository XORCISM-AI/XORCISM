"""run.py — XORCISM OSINT pivot connector: Have I Been Squatted?.

Domain Name OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/have-i-been-squatted

Turns a `target` observable into a pivot — a deep-link into Have I Been Squatted? when it exposes
...
SLUG = 'have-i-been-squatted'
TOOL_NAME = 'Have I Been Squatted?'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/have-i-been-squatted'
CATEGORY = 'Domain Name OSINT'
