"""run.py — XORCISM OSINT pivot connector: Story Saver.

Social Media OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/story-saver-instagram

Turns a `target` observable into a pivot — a deep-link into Story Saver when it exposes
...
SLUG = 'story-saver-instagram'
TOOL_NAME = 'Story Saver'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/story-saver-instagram'
