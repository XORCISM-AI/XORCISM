"""run.py — XORCISM OSINT pivot connector: Pic Detective.

Image & Video Analysis OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/pic-detective

Turns a `target` observable into a pivot — a deep-link into Pic Detective when it exposes
...
SLUG = 'pic-detective'
TOOL_NAME = 'Pic Detective'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/pic-detective'
