"""run.py — XORCISM OSINT pivot connector: Dorky.

Network Infrastructure OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/dorky

Turns a `target` observable into a pivot — a deep-link into Dorky when it exposes
...
SLUG = 'dorky'
TOOL_NAME = 'Dorky'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/dorky'
