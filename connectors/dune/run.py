"""run.py — XORCISM OSINT pivot connector: Dune.

Blockchain/Cryptocurrency OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/dune

Turns a `target` observable into a pivot — a deep-link into Dune when it exposes
...
SLUG = 'dune'
TOOL_NAME = 'Dune'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/dune'
