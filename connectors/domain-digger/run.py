"""run.py — XORCISM OSINT pivot connector: Domain Digger.

Network Infrastructure OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/domain-digger

Turns a `target` observable into a pivot — a deep-link into Domain Digger when it exposes
...
SLUG = 'domain-digger'
TOOL_NAME = 'Domain Digger'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/domain-digger'
