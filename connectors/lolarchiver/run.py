"""run.py — XORCISM OSINT pivot connector: LoLArchiver.

Email Address OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/lolarchiver

Turns a `target` observable into a pivot — a deep-link into LoLArchiver when it exposes
...
SLUG = 'lolarchiver'
TOOL_NAME = 'LoLArchiver'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/lolarchiver'
