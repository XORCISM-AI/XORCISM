"""run.py — XORCISM connector SCAFFOLD for Perplexity AI.

AI search with cited sources
Tool: https://perplexity.ai/
Category: OSINT   (XORCISM.TOOL #838)

Generated by connectors/tool_to_connector.py. Implement run() to map Perplexity AI output to
...
def run(params: Dict[str, Any], workdir: str) -> Dict[str, Any]:  # noqa: ARG001
    ...
    # TODO: implement the Perplexity AI integration:
    #   • live mode  -> invoke Perplexity AI against `target` (respect the engagement scope), or
    #   • offline    -> parse the saved output at `path`,
    # then return the normalized result (example shape below).
    raise NotImplementedError(
        f"Connector 'perplexity-ai' ({TOOL_NAME}) is a scaffold - implement run() in "
        f"connectors/perplexity-ai/run.py (tool: {TOOL_URL})."
    )
