"""run.py — XORCISM OSINT pivot connector: Host.io.

Domain Name OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/host.io

Turns a `target` observable into a pivot — a deep-link into Host.io when it exposes
...
SLUG = 'host.io'
TOOL_NAME = 'Host.io'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/host.io'
