"""run.py — XORCISM OSINT pivot connector: Picarta.

Geolocation & Maps OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/picarta

Turns a `target` observable into a pivot — a deep-link into Picarta when it exposes
...
SLUG = 'picarta'
TOOL_NAME = 'Picarta'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/picarta'
