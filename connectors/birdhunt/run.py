"""run.py — XORCISM OSINT pivot connector: BirdHunt.

Social Media OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/birdhunt

Turns a `target` observable into a pivot — a deep-link into BirdHunt when it exposes
...
SLUG = 'birdhunt'
TOOL_NAME = 'BirdHunt'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/birdhunt'
