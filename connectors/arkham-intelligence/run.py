"""run.py — XORCISM OSINT pivot connector: Arkham Intelligence.

Blockchain/Cryptocurrency OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/arkham

Turns a `target` observable into a pivot — a deep-link into Arkham Intelligence when it exposes
...
SLUG = 'arkham'
TOOL_NAME = 'Arkham Intelligence'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/arkham'
