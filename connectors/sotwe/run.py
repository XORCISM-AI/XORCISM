"""run.py — XORCISM OSINT pivot connector: Sotwe.

Social Media OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/sotwe

Turns a `target` observable into a pivot — a deep-link into Sotwe when it exposes
...
SLUG = 'sotwe'
TOOL_NAME = 'Sotwe'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/sotwe'
