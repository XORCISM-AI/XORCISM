"""run.py — XORCISM OSINT pivot connector: Central Ops.

Domain Name OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/central-ops

Turns a `target` observable into a pivot — a deep-link into Central Ops when it exposes
...
SLUG = 'central-ops'
TOOL_NAME = 'Central Ops'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/central-ops'
