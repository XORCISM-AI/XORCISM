"""run.py — XORCISM OSINT pivot connector: urlscan.io.

Domain Name OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/urlscan.io

Turns a `target` observable into a pivot — a deep-link into urlscan.io when it exposes
...
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/urlscan.io'
