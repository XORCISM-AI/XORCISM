"""run.py — XORCISM OSINT pivot connector: DNS Dumpster.

Domain Name OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/dns-dumpster

Turns a `target` observable into a pivot — a deep-link into DNS Dumpster when it exposes
...
SLUG = 'dns-dumpster'
TOOL_NAME = 'DNS Dumpster'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/dns-dumpster'
