"""run.py — XORCISM connector SCAFFOLD for Impacket.

Python classes for working with network protocols such as SMB and Kerberos.
Tool: https://github.com/fortra/impacket
Category: Credential Access   (XORCISM.TOOL #76)

Generated by connectors/tool_to_connector.py. Implement run() to map Impacket output to
...
def run(params: Dict[str, Any], workdir: str) -> Dict[str, Any]:  # noqa: ARG001
    ...
    # TODO: implement the Impacket integration:
    #   • live mode  -> invoke Impacket against `target` (respect the engagement scope), or
    #   • offline    -> parse the saved output at `path`,
    # then return the normalized result (example shape below).
    raise NotImplementedError(
        f"Connector 'impacket' ({TOOL_NAME}) is a scaffold - implement run() in "
        f"connectors/impacket/run.py (tool: {TOOL_URL})."
    )
