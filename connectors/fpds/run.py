"""run.py — XORCISM OSINT pivot connector: FPDS.

Public Records OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/fpds

Turns a `target` observable into a pivot — a deep-link into FPDS when it exposes
...
SLUG = 'fpds'
TOOL_NAME = 'FPDS'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/fpds'
