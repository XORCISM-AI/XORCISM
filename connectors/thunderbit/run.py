"""run.py — XORCISM OSINT pivot connector: Thunderbit.

Data Extraction OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/thunderbit

Turns a `target` observable into a pivot — a deep-link into Thunderbit when it exposes
...
SLUG = 'thunderbit'
TOOL_NAME = 'Thunderbit'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/thunderbit'
