"""run.py — XORCISM OSINT pivot connector: Phunter.

Phone Number OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/phunter

Turns a `target` observable into a pivot — a deep-link into Phunter when it exposes
...
SLUG = 'phunter'
TOOL_NAME = 'Phunter'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/phunter'
