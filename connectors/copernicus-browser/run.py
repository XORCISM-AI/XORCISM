"""run.py — XORCISM OSINT pivot connector: Copernicus Browser.

Geolocation & Maps OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/copernicus-browser

Turns a `target` observable into a pivot — a deep-link into Copernicus Browser when it exposes
...
SLUG = 'copernicus-browser'
TOOL_NAME = 'Copernicus Browser'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/copernicus-browser'
