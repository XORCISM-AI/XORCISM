"""run.py — XORCISM OSINT pivot connector: Vehicle AI.

Transport OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/vehicle-ai

Turns a `target` observable into a pivot — a deep-link into Vehicle AI when it exposes
...
SLUG = 'vehicle-ai'
TOOL_NAME = 'Vehicle AI'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/vehicle-ai'
