"""run.py — XORCISM OSINT pivot connector: EU Sanctions Map.

Public Records OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/eu-sanctions-map

Turns a `target` observable into a pivot — a deep-link into EU Sanctions Map when it exposes
...
SLUG = 'eu-sanctions-map'
TOOL_NAME = 'EU Sanctions Map'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/eu-sanctions-map'
