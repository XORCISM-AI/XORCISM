"""run.py — XORCISM OSINT pivot connector: Simple Scraper.

Data Extraction OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/simple-scraper

Turns a `target` observable into a pivot — a deep-link into Simple Scraper when it exposes
...
SLUG = 'simple-scraper'
TOOL_NAME = 'Simple Scraper'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/simple-scraper'
CATEGORY = 'Data Extraction OSINT'
