"""run.py — XORCISM connector SCAFFOLD for Microsoft Copilot.

AI with Bing search integration
Tool: https://copilot.microsoft.com/
Category: OSINT   (XORCISM.TOOL #842)

Generated by connectors/tool_to_connector.py. Implement run() to map Microsoft Copilot output to
...
def run(params: Dict[str, Any], workdir: str) -> Dict[str, Any]:  # noqa: ARG001
    ...
    # TODO: implement the Microsoft Copilot integration:
    #   • live mode  -> invoke Microsoft Copilot against `target` (respect the engagement scope), or
    #   • offline    -> parse the saved output at `path`,
    # then return the normalized result (example shape below).
    raise NotImplementedError(
        f"Connector 'microsoft-copilot' ({TOOL_NAME}) is a scaffold - implement run() in "
        f"connectors/microsoft-copilot/run.py (tool: {TOOL_URL})."
    )
