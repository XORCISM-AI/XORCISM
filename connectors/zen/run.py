"""run.py — XORCISM OSINT pivot connector: Zen.

Email Address OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/zen

Turns a `target` observable into a pivot — a deep-link into Zen when it exposes
...
SLUG = 'zen'
TOOL_NAME = 'Zen'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/zen'
