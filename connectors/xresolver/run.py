"""run.py — XORCISM OSINT pivot connector: XResolver.

Network Infrastructure OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/xresolver

Turns a `target` observable into a pivot — a deep-link into XResolver when it exposes
...
SLUG = 'xresolver'
TOOL_NAME = 'XResolver'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/xresolver'
