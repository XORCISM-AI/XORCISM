"""run.py — XORCISM OSINT pivot connector: Epieos.

Email Address OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/epieos

Turns a `target` observable into a pivot — a deep-link into Epieos when it exposes
...
SLUG = 'epieos'
TOOL_NAME = 'Epieos'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/epieos'
