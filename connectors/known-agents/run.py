"""run.py — XORCISM OSINT pivot connector: Known Agents.

Foundational OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/known-agents

Turns a `target` observable into a pivot — a deep-link into Known Agents when it exposes
...
SLUG = 'known-agents'
TOOL_NAME = 'Known Agents'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/known-agents'
