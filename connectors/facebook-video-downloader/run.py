"""run.py — XORCISM OSINT pivot connector: Facebook Video Downloader.

Social Media OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/facebook-video-downloader

Turns a `target` observable into a pivot — a deep-link into Facebook Video Downloader when it exposes
...
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/facebook-video-downloader'
