"""run.py — XORCISM OSINT pivot connector: FOFA.

Network Infrastructure OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/fofa

Turns a `target` observable into a pivot — a deep-link into FOFA when it exposes
...
SLUG = 'fofa'
TOOL_NAME = 'FOFA'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/fofa'
