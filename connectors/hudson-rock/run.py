"""run.py — XORCISM OSINT pivot connector: Hudson Rock.

Cyberthreat Intelligence OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/hudson-rock

Turns a `target` observable into a pivot — a deep-link into Hudson Rock when it exposes
...
SLUG = 'hudson-rock'
TOOL_NAME = 'Hudson Rock'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/hudson-rock'
CATEGORY = 'Cyberthreat Intelligence OSINT'
