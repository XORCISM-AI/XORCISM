"""run.py — XORCISM OSINT pivot connector: IDCrawl.

People OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/idcrawl

Turns a `target` observable into a pivot — a deep-link into IDCrawl when it exposes
...
SLUG = 'idcrawl'
TOOL_NAME = 'IDCrawl'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/idcrawl'
