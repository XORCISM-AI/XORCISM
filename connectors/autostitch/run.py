"""run.py — XORCISM OSINT pivot connector: Autostitch.

Image & Video Analysis OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/autostitch

Turns a `target` observable into a pivot — a deep-link into Autostitch when it exposes
...
SLUG = 'autostitch'
TOOL_NAME = 'Autostitch'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/autostitch'
