"""run.py — XORCISM OSINT pivot connector: Companies House (UK).

Public Records OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/companies-house

Turns a `target` observable into a pivot — a deep-link into Companies House (UK) when it exposes
...
TOOL_NAME = 'Companies House (UK)'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/companies-house'
