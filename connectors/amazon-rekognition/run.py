"""run.py — XORCISM OSINT pivot connector: Amazon Rekognition.

Image & Video Analysis OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/amazon-rekognition

Turns a `target` observable into a pivot — a deep-link into Amazon Rekognition when it exposes
...
TOOL_NAME = 'Amazon Rekognition'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/amazon-rekognition'
