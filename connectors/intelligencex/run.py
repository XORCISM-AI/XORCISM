"""run.py — XORCISM OSINT pivot connector: IntelligenceX.

Network Infrastructure OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/intelligencex

Turns a `target` observable into a pivot — a deep-link into IntelligenceX when it exposes
...
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/intelligencex'
