"""run.py — XORCISM OSINT pivot connector: Discord Leaks.

Social Media OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/discord-leaks

Turns a `target` observable into a pivot — a deep-link into Discord Leaks when it exposes
...
SLUG = 'discord-leaks'
TOOL_NAME = 'Discord Leaks'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/discord-leaks'
