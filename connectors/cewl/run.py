"""run.py — XORCISM connector SCAFFOLD for CeWL.

Custom wordlist generator from website
Tool: n/a
Category: OSINT   (XORCISM.TOOL #783)

Generated by connectors/tool_to_connector.py. Implement run() to map CeWL output to
...
def run(params: Dict[str, Any], workdir: str) -> Dict[str, Any]:  # noqa: ARG001
    ...
    # TODO: implement the CeWL integration:
    #   • live mode  -> invoke CeWL against `target` (respect the engagement scope), or
    #   • offline    -> parse the saved output at `path`,
    # then return the normalized result (example shape below).
    raise NotImplementedError(
        f"Connector 'cewl' ({TOOL_NAME}) is a scaffold - implement run() in "
        f"connectors/cewl/run.py (tool: {TOOL_URL})."
    )
