"""run.py — XORCISM OSINT pivot connector: Ubikron.

Foundational OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/ubikron

Turns a `target` observable into a pivot — a deep-link into Ubikron when it exposes
...
SLUG = 'ubikron'
TOOL_NAME = 'Ubikron'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/ubikron'
