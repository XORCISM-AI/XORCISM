"""run.py — XORCISM OSINT pivot connector: GeoHints.

Geolocation & Maps OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/geohints

Turns a `target` observable into a pivot — a deep-link into GeoHints when it exposes
...
SLUG = 'geohints'
TOOL_NAME = 'GeoHints'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/geohints'
