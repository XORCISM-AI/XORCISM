"""run.py — XORCISM OSINT pivot connector: Forensically.

Image & Video Analysis OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/forensically

Turns a `target` observable into a pivot — a deep-link into Forensically when it exposes
...
SLUG = 'forensically'
TOOL_NAME = 'Forensically'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/forensically'
