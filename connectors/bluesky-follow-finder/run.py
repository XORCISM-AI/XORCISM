"""run.py — XORCISM OSINT pivot connector: Bluesky Follow Finder.

Social Media OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/bluesky-follow-finder

Turns a `target` observable into a pivot — a deep-link into Bluesky Follow Finder when it exposes
...
SLUG = 'bluesky-follow-finder'
TOOL_NAME = 'Bluesky Follow Finder'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/bluesky-follow-finder'
