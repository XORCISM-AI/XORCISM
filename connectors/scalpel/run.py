"""run.py — XORCISM connector SCAFFOLD for Scalpel.

File carving tool
Tool: n/a
Category: OSINT   (XORCISM.TOOL #863)

Generated by connectors/tool_to_connector.py. Implement run() to map Scalpel output to
...
def run(params: Dict[str, Any], workdir: str) -> Dict[str, Any]:  # noqa: ARG001
    ...
    # TODO: implement the Scalpel integration:
    #   • live mode  -> invoke Scalpel against `target` (respect the engagement scope), or
    #   • offline    -> parse the saved output at `path`,
    # then return the normalized result (example shape below).
    raise NotImplementedError(
        f"Connector 'scalpel' ({TOOL_NAME}) is a scaffold - implement run() in "
        f"connectors/scalpel/run.py (tool: {TOOL_URL})."
    )
