"""run.py — XORCISM OSINT pivot connector: WhatsMyName.

Username OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/whatsmyname

Turns a `target` observable into a pivot — a deep-link into WhatsMyName when it exposes
...
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/whatsmyname'
