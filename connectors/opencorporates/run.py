"""run.py — XORCISM connector SCAFFOLD for OpenCorporates.

Global corporate database
Tool: https://opencorporates.com/
Category: OSINT   (XORCISM.TOOL #846)

Generated by connectors/tool_to_connector.py. Implement run() to map OpenCorporates output to
...
def run(params: Dict[str, Any], workdir: str) -> Dict[str, Any]:  # noqa: ARG001
    ...
    # TODO: implement the OpenCorporates integration:
    #   • live mode  -> invoke OpenCorporates against `target` (respect the engagement scope), or
    #   • offline    -> parse the saved output at `path`,
    # then return the normalized result (example shape below).
    raise NotImplementedError(
        f"Connector 'opencorporates' ({TOOL_NAME}) is a scaffold - implement run() in "
        f"connectors/opencorporates/run.py (tool: {TOOL_URL})."
    )
