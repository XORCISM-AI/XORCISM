"""run.py — XORCISM OSINT pivot connector: Twitter Viewer.

Social Media OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/twitter-viewer

Turns a `target` observable into a pivot — a deep-link into Twitter Viewer when it exposes
...
SLUG = 'twitter-viewer'
TOOL_NAME = 'Twitter Viewer'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/twitter-viewer'
