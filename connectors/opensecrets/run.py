"""run.py — XORCISM OSINT pivot connector: OpenSecrets.

Public Records OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/opensecrets

Turns a `target` observable into a pivot — a deep-link into OpenSecrets when it exposes
...
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/opensecrets'
