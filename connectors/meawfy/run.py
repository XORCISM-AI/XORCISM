"""run.py — XORCISM OSINT pivot connector: Meawfy.

Cyberthreat Intelligence OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/meawfy

Turns a `target` observable into a pivot — a deep-link into Meawfy when it exposes
...
SLUG = 'meawfy'
TOOL_NAME = 'Meawfy'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/meawfy'
