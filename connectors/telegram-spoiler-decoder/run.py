"""run.py — XORCISM OSINT pivot connector: Telegram Spoiler Decoder.

Social Media OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/telegram-spoiler-decoder

Turns a `target` observable into a pivot — a deep-link into Telegram Spoiler Decoder when it exposes
...
SLUG = 'telegram-spoiler-decoder'
TOOL_NAME = 'Telegram Spoiler Decoder'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/telegram-spoiler-decoder'
