"""run.py — XORCISM OSINT pivot connector: Telegram Phone Number Checker.

Phone Number OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/telegram-phone-number-checker

Turns a `target` observable into a pivot — a deep-link into Telegram Phone Number Checker when it exposes
...
SLUG = 'telegram-phone-number-checker'
TOOL_NAME = 'Telegram Phone Number Checker'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/telegram-phone-number-checker'
