"""run.py — XORCISM OSINT pivot connector: SIERRA.

Foundational OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/sierra

Turns a `target` observable into a pivot — a deep-link into SIERRA when it exposes
...
SLUG = 'sierra'
TOOL_NAME = 'SIERRA'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/sierra'
