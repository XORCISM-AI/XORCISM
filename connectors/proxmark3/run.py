"""run.py — XORCISM connector SCAFFOLD for Proxmark3.

RFID/NFC research & cloning tool
Tool: n/a
Category: OSINT   (XORCISM.TOOL #895)

Generated by connectors/tool_to_connector.py. Implement run() to map Proxmark3 output to
...
def run(params: Dict[str, Any], workdir: str) -> Dict[str, Any]:  # noqa: ARG001
    ...
    # TODO: implement the Proxmark3 integration:
    #   • live mode  -> invoke Proxmark3 against `target` (respect the engagement scope), or
    #   • offline    -> parse the saved output at `path`,
    # then return the normalized result (example shape below).
    raise NotImplementedError(
        f"Connector 'proxmark3' ({TOOL_NAME}) is a scaffold - implement run() in "
        f"connectors/proxmark3/run.py (tool: {TOOL_URL})."
    )
