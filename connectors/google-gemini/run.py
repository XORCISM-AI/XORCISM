"""run.py — XORCISM connector SCAFFOLD for Google Gemini.

Google AI with web search
Tool: https://gemini.google.com/
Category: OSINT   (XORCISM.TOOL #839)

Generated by connectors/tool_to_connector.py. Implement run() to map Google Gemini output to
...
def run(params: Dict[str, Any], workdir: str) -> Dict[str, Any]:  # noqa: ARG001
    ...
    # TODO: implement the Google Gemini integration:
    #   • live mode  -> invoke Google Gemini against `target` (respect the engagement scope), or
    #   • offline    -> parse the saved output at `path`,
    # then return the normalized result (example shape below).
    raise NotImplementedError(
        f"Connector 'google-gemini' ({TOOL_NAME}) is a scaffold - implement run() in "
        f"connectors/google-gemini/run.py (tool: {TOOL_URL})."
    )
