"""run.py — XORCISM OSINT pivot connector: DeepL Translator.

Language Translation OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/deepl-translator

Turns a `target` observable into a pivot — a deep-link into DeepL Translator when it exposes
...
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/deepl-translator'
