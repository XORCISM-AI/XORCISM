"""run.py — XORCISM OSINT pivot connector: Govsky.

Social Media OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/govsky

Turns a `target` observable into a pivot — a deep-link into Govsky when it exposes
...
SLUG = 'govsky'
TOOL_NAME = 'Govsky'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/govsky'
