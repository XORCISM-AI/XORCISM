"""run.py — XORCISM OSINT pivot connector: Open Measures.

Social Media OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/open-measures

Turns a `target` observable into a pivot — a deep-link into Open Measures when it exposes
...
SLUG = 'open-measures'
TOOL_NAME = 'Open Measures'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/open-measures'
