"""run.py — XORCISM OSINT pivot connector: Profile Image Intel.

Image & Video Analysis OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/profile-image-intel

Turns a `target` observable into a pivot — a deep-link into Profile Image Intel when it exposes
...
SLUG = 'profile-image-intel'
TOOL_NAME = 'Profile Image Intel'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/profile-image-intel'
