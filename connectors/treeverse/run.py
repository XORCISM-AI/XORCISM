"""run.py — XORCISM OSINT pivot connector: Treeverse.

Social Media OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/treeverse

Turns a `target` observable into a pivot — a deep-link into Treeverse when it exposes
...
SLUG = 'treeverse'
TOOL_NAME = 'Treeverse'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/treeverse'
