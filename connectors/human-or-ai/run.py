"""run.py — XORCISM OSINT pivot connector: Human or AI.

Foundational OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/human-or-ai

Turns a `target` observable into a pivot — a deep-link into Human or AI when it exposes
...
SLUG = 'human-or-ai'
TOOL_NAME = 'Human or AI'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/human-or-ai'
