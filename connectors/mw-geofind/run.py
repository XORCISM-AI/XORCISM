"""run.py — XORCISM OSINT pivot connector: MW Geofind.

Geolocation & Maps OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/mw-geofind

Turns a `target` observable into a pivot — a deep-link into MW Geofind when it exposes
...
SLUG = 'mw-geofind'
TOOL_NAME = 'MW Geofind'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/mw-geofind'
