"""run.py — XORCISM OSINT pivot connector: AzSky.

Social Media OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/azsky

Turns a `target` observable into a pivot — a deep-link into AzSky when it exposes
...
SLUG = 'azsky'
TOOL_NAME = 'AzSky'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/azsky'
