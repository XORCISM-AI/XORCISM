"""run.py — XORCISM OSINT pivot connector: Surveillance under Surveillance.

Geolocation & Maps OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/surveillance-under-surveillance

Turns a `target` observable into a pivot — a deep-link into Surveillance under Surveillance when it exposes
...
SLUG = 'surveillance-under-surveillance'
TOOL_NAME = 'Surveillance under Surveillance'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/surveillance-under-surveillance'
