"""run.py — XORCISM connector SCAFFOLD for Evil-WinRM.

The ultimate WinRM shell for hacking and pentesting.
Tool: https://github.com/Hackplayers/evil-winrm
Category: Post-Exploitation   (XORCISM.TOOL #79)

Generated by connectors/tool_to_connector.py. Implement run() to map Evil-WinRM output to
...
def run(params: Dict[str, Any], workdir: str) -> Dict[str, Any]:  # noqa: ARG001
    ...
    # TODO: implement the Evil-WinRM integration:
    #   • live mode  -> invoke Evil-WinRM against `target` (respect the engagement scope), or
    #   • offline    -> parse the saved output at `path`,
    # then return the normalized result (example shape below).
    raise NotImplementedError(
        f"Connector 'evil-winrm' ({TOOL_NAME}) is a scaffold - implement run() in "
        f"connectors/evil-winrm/run.py (tool: {TOOL_URL})."
    )
