"""run.py — XORCISM OSINT pivot connector: Domain Dossier.

Domain Name OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/domain-dossier

Turns a `target` observable into a pivot — a deep-link into Domain Dossier when it exposes
...
SLUG = 'domain-dossier'
TOOL_NAME = 'Domain Dossier'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/domain-dossier'
