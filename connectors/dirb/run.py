"""run.py — XORCISM connector SCAFFOLD for Dirb.

Web directory brute-forcer
Tool: n/a
Category: OSINT   (XORCISM.TOOL #809)

Generated by connectors/tool_to_connector.py. Implement run() to map Dirb output to
...
def run(params: Dict[str, Any], workdir: str) -> Dict[str, Any]:  # noqa: ARG001
    ...
    # TODO: implement the Dirb integration:
    #   • live mode  -> invoke Dirb against `target` (respect the engagement scope), or
    #   • offline    -> parse the saved output at `path`,
    # then return the normalized result (example shape below).
    raise NotImplementedError(
        f"Connector 'dirb' ({TOOL_NAME}) is a scaffold - implement run() in "
        f"connectors/dirb/run.py (tool: {TOOL_URL})."
    )
