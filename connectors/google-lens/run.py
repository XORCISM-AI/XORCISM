"""run.py — XORCISM OSINT pivot connector: Google Lens.

Image & Video Analysis OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/google-lens

Turns a `target` observable into a pivot — a deep-link into Google Lens when it exposes
...
SLUG = 'google-lens'
TOOL_NAME = 'Google Lens'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/google-lens'
