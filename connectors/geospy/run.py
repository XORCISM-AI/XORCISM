"""run.py — XORCISM OSINT pivot connector: GeoSpy.

Geolocation & Maps OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/geospy

Turns a `target` observable into a pivot — a deep-link into GeoSpy when it exposes
...
SLUG = 'geospy'
TOOL_NAME = 'GeoSpy'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/geospy'
