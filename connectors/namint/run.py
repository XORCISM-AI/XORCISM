"""run.py — XORCISM OSINT pivot connector: NAMINT.

Username OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/namint

Turns a `target` observable into a pivot — a deep-link into NAMINT when it exposes
...
SLUG = 'namint'
TOOL_NAME = 'NAMINT'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/namint'
