"""run.py — XORCISM OSINT pivot connector: Telemetry.

Social Media OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/telemetry

Turns a `target` observable into a pivot — a deep-link into Telemetry when it exposes
...
SLUG = 'telemetry'
TOOL_NAME = 'Telemetry'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/telemetry'
