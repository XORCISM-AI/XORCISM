"""run.py — XORCISM connector SCAFFOLD for RockYou.

Classic leaked password list
Tool: n/a
Category: OSINT   (XORCISM.TOOL #891)

Generated by connectors/tool_to_connector.py. Implement run() to map RockYou output to
...
def run(params: Dict[str, Any], workdir: str) -> Dict[str, Any]:  # noqa: ARG001
    ...
    # TODO: implement the RockYou integration:
    #   • live mode  -> invoke RockYou against `target` (respect the engagement scope), or
    #   • offline    -> parse the saved output at `path`,
    # then return the normalized result (example shape below).
    raise NotImplementedError(
        f"Connector 'rockyou' ({TOOL_NAME}) is a scaffold - implement run() in "
        f"connectors/rockyou/run.py (tool: {TOOL_URL})."
    )
