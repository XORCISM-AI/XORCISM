"""run.py — XORCISM OSINT pivot connector: Wikimapia.

Geolocation & Maps OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/wikimapia

Turns a `target` observable into a pivot — a deep-link into Wikimapia when it exposes
...
SLUG = 'wikimapia'
TOOL_NAME = 'Wikimapia'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/wikimapia'
