"""run.py — XORCISM OSINT pivot connector: Snap Map.

Social Media OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/snap-map

Turns a `target` observable into a pivot — a deep-link into Snap Map when it exposes
...
SLUG = 'snap-map'
TOOL_NAME = 'Snap Map'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/snap-map'
