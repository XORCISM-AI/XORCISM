"""run.py — XORCISM OSINT pivot connector: PhishTank.

Network Infrastructure OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/phishtank

Turns a `target` observable into a pivot — a deep-link into PhishTank when it exposes
...
SLUG = 'phishtank'
TOOL_NAME = 'PhishTank'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/phishtank'
