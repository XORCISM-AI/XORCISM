"""run.py — XORCISM OSINT pivot connector: PimEyes.

Image & Video Analysis OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/pimeyes

Turns a `target` observable into a pivot — a deep-link into PimEyes when it exposes
...
SLUG = 'pimeyes'
TOOL_NAME = 'PimEyes'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/pimeyes'
