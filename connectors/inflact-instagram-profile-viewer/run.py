"""run.py — XORCISM OSINT pivot connector: Inflact Instagram Profile Viewer.

Social Media OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/inflact-instagram-profile-viewer

Turns a `target` observable into a pivot — a deep-link into Inflact Instagram Profile Viewer when it exposes
...
SLUG = 'inflact-instagram-profile-viewer'
TOOL_NAME = 'Inflact Instagram Profile Viewer'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/inflact-instagram-profile-viewer'
