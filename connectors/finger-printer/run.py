"""run.py — XORCISM OSINT pivot connector: Finger Printer.

Foundational OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/finger-printer

Turns a `target` observable into a pivot — a deep-link into Finger Printer when it exposes
...
SLUG = 'finger-printer'
TOOL_NAME = 'Finger Printer'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/finger-printer'
