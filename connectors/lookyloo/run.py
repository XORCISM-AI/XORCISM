"""run.py — XORCISM OSINT pivot connector: Lookyloo.

Network Infrastructure OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/lookyloo

Turns a `target` observable into a pivot — a deep-link into Lookyloo when it exposes
...
SLUG = 'lookyloo'
TOOL_NAME = 'Lookyloo'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/lookyloo'
