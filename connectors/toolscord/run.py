"""run.py — XORCISM OSINT pivot connector: ToolsCord.

Social Media OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/toolscord

Turns a `target` observable into a pivot — a deep-link into ToolsCord when it exposes
...
SLUG = 'toolscord'
TOOL_NAME = 'ToolsCord'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/toolscord'
