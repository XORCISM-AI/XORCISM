"""run.py — XORCISM OSINT pivot connector: TheBigBrother.

Username OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/thebigbrother

Turns a `target` observable into a pivot — a deep-link into TheBigBrother when it exposes
...
SLUG = 'thebigbrother'
TOOL_NAME = 'TheBigBrother'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/thebigbrother'
