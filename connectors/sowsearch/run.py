"""run.py — XORCISM OSINT pivot connector: Sowsearch.

Social Media OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/sowsearch

Turns a `target` observable into a pivot — a deep-link into Sowsearch when it exposes
...
SLUG = 'sowsearch'
TOOL_NAME = 'Sowsearch'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/sowsearch'
