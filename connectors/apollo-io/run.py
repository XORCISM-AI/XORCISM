"""run.py — XORCISM connector SCAFFOLD for Apollo.io.

B2B phone/email finder — 1200 free credits/yr
Tool: https://www.apollo.io
Category: OSINT   (XORCISM.TOOL #1022)

Generated by connectors/tool_to_connector.py. Implement run() to map Apollo.io output to
...
def run(params: Dict[str, Any], workdir: str) -> Dict[str, Any]:  # noqa: ARG001
    ...
    # TODO: implement the Apollo.io integration:
    #   • live mode  -> invoke Apollo.io against `target` (respect the engagement scope), or
    #   • offline    -> parse the saved output at `path`,
    # then return the normalized result (example shape below).
    raise NotImplementedError(
        f"Connector 'apollo-io' ({TOOL_NAME}) is a scaffold - implement run() in "
        f"connectors/apollo-io/run.py (tool: {TOOL_URL})."
    )
