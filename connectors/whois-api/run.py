"""run.py — XORCISM OSINT pivot connector: WHOIS API.

Domain Name OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/whois-api

Turns a `target` observable into a pivot — a deep-link into WHOIS API when it exposes
...
SLUG = 'whois-api'
TOOL_NAME = 'WHOIS API'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/whois-api'
