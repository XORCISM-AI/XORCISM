"""run.py — XORCISM OSINT pivot connector: Instagram Map.

Social Media OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/instagram-map

Turns a `target` observable into a pivot — a deep-link into Instagram Map when it exposes
...
SLUG = 'instagram-map'
TOOL_NAME = 'Instagram Map'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/instagram-map'
