"""run.py — XORCISM OSINT pivot connector: Osintly.

Email Address OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/osintly

Turns a `target` observable into a pivot — a deep-link into Osintly when it exposes
...
SLUG = 'osintly'
TOOL_NAME = 'Osintly'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/osintly'
