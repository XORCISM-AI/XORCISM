"""run.py — XORCISM OSINT pivot connector: SPOT.

Geolocation & Maps OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/spot

Turns a `target` observable into a pivot — a deep-link into SPOT when it exposes
...
SLUG = 'spot'
TOOL_NAME = 'SPOT'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/spot'
