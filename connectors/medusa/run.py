"""run.py — XORCISM connector SCAFFOLD for Medusa.

Speedy, modular, parallel network login brute-forcer.
Tool: https://github.com/jmk-foofus/medusa
Category: Password Cracking   (XORCISM.TOOL #70)

Generated by connectors/tool_to_connector.py. Implement run() to map Medusa output to
...
def run(params: Dict[str, Any], workdir: str) -> Dict[str, Any]:  # noqa: ARG001
    ...
    # TODO: implement the Medusa integration:
    #   • live mode  -> invoke Medusa against `target` (respect the engagement scope), or
    #   • offline    -> parse the saved output at `path`,
    # then return the normalized result (example shape below).
    raise NotImplementedError(
        f"Connector 'medusa' ({TOOL_NAME}) is a scaffold - implement run() in "
        f"connectors/medusa/run.py (tool: {TOOL_URL})."
    )
