"""run.py — XORCISM OSINT pivot connector: Internect.info.

Social Media OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/internect.info

Turns a `target` observable into a pivot — a deep-link into Internect.info when it exposes
...
SLUG = 'internect.info'
TOOL_NAME = 'Internect.info'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/internect.info'
