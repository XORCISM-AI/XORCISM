"""run.py — XORCISM connector SCAFFOLD for MAC Changer.

Change/spoof MAC address
Tool: n/a
Category: OSINT   (XORCISM.TOOL #803)

Generated by connectors/tool_to_connector.py. Implement run() to map MAC Changer output to
...
def run(params: Dict[str, Any], workdir: str) -> Dict[str, Any]:  # noqa: ARG001
    ...
    # TODO: implement the MAC Changer integration:
    #   • live mode  -> invoke MAC Changer against `target` (respect the engagement scope), or
    #   • offline    -> parse the saved output at `path`,
    # then return the normalized result (example shape below).
    raise NotImplementedError(
        f"Connector 'mac-changer' ({TOOL_NAME}) is a scaffold - implement run() in "
        f"connectors/mac-changer/run.py (tool: {TOOL_URL})."
    )
