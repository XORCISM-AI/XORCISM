"""run.py — XORCISM OSINT pivot connector: Hippie OSINT Toolkit.

Username OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/hippie-osint-toolkit

Turns a `target` observable into a pivot — a deep-link into Hippie OSINT Toolkit when it exposes
...
SLUG = 'hippie-osint-toolkit'
TOOL_NAME = 'Hippie OSINT Toolkit'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/hippie-osint-toolkit'
