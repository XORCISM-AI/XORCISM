"""run.py — XORCISM OSINT pivot connector: Netlas.

Network Infrastructure OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/netlas

Turns a `target` observable into a pivot — a deep-link into Netlas when it exposes
...
SLUG = 'netlas'
TOOL_NAME = 'Netlas'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/netlas'
