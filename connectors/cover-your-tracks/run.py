"""run.py — XORCISM OSINT pivot connector: Cover Your Tracks.

Foundational OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/cover-your-tracks

Turns a `target` observable into a pivot — a deep-link into Cover Your Tracks when it exposes
...
TOOL_NAME = 'Cover Your Tracks'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/cover-your-tracks'
