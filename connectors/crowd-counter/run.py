"""run.py — XORCISM OSINT pivot connector: Crowd Counter.

Image & Video Analysis OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/crowd-counter

Turns a `target` observable into a pivot — a deep-link into Crowd Counter when it exposes
...
SLUG = 'crowd-counter'
TOOL_NAME = 'Crowd Counter'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/crowd-counter'
