"""run.py — XORCISM OSINT pivot connector: File Phish.

Cyberthreat Intelligence OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/file-phish

Turns a `target` observable into a pivot — a deep-link into File Phish when it exposes
...
SLUG = 'file-phish'
TOOL_NAME = 'File Phish'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/file-phish'
