"""run.py — XORCISM OSINT pivot connector: Flightradar24.

Transport OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/flightradar24

Turns a `target` observable into a pivot — a deep-link into Flightradar24 when it exposes
...
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/flightradar24'
