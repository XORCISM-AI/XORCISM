"""run.py — XORCISM OSINT pivot connector: OpenGraph Intel.

Foundational OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/opengraph-intel

Turns a `target` observable into a pivot — a deep-link into OpenGraph Intel when it exposes
...
SLUG = 'opengraph-intel'
TOOL_NAME = 'OpenGraph Intel'
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/opengraph-intel'
