"""run.py — XORCISM OSINT pivot connector: MarineTraffic.

Transport OSINT tool from the OSINT Newsletter tools library.
Tool: https://tools.osintnewsletter.com/osint-tools/marinetraffic

Turns a `target` observable into a pivot — a deep-link into MarineTraffic when it exposes
...
TOOL_URL = 'https://tools.osintnewsletter.com/osint-tools/marinetraffic'
