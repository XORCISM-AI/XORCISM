...
CREATE TABLE IF NOT EXISTS XENROLLKEY ( EnrollKeyID INTEGER PRIMARY KEY AUTOINCREMENT, TenantID INTEGER, Label TEXT NOT NULL, Prefix TEXT NOT NULL, KeyHash TEXT NOT NULL UNIQUE, CreatedByUserID INTEGER, CreatedDate TEXT NOT NULL, ExpiresDate TEXT, LastUsedDate TEXT, UseCount INTEGER NOT NULL DEFAULT 0, Revoked INTEGER NOT NULL DEFAULT 0 );
